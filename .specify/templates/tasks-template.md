...
- **Hexagonal layout** (fixed folders):
  ...
  - Outbound: `src/adapters/outbound/{mongodb,ldap}/`
  - Infrastructure: `src/infrastructure/{config,errors,middleware}/` and `src/infrastructure/main.py`
- Include exact file paths in descriptions and keep adapter vs core responsibilities explicit
